...
- [x] Hozzáadtunk egy `supabase/migrations/20260207000000_bonus_system_privilege_contract_reapply.sql` migrációt, amely ugyanazokat az utasításokat futtatja új timestamptel, így a push után garantáltan az elvárt privilege állapot lesz érvényben.
