...
| -------- | ------- | ------------------------ | ---------- | --------------------------- |
| Task-specifikus DoD pontok teljesulnek | FAIL | canvases/audit_p1/setup_guide_sdk_redirect_clarity.md | Implementacio utan toltendo. | ./scripts/verify.sh --report ... |
