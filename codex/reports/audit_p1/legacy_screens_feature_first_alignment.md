...
| -------- | ------- | ------------------------ | ---------- | --------------------------- |
| Task-specifikus DoD pontok teljesulnek | FAIL | canvases/audit_p1/legacy_screens_feature_first_alignment.md | Implementacio utan toltendo. | ./scripts/verify.sh --report ... |
