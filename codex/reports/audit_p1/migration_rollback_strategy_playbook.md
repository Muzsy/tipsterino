...
| -------- | ------- | ------------------------ | ---------- | --------------------------- |
| Task-specifikus DoD pontok teljesulnek | FAIL | canvases/audit_p1/migration_rollback_strategy_playbook.md | Implementacio utan toltendo. | ./scripts/verify.sh --report ... |
